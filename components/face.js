...
export default class CameraExample extends React.Component {
  ...
  state = {
    ...
    smileProbability: null, //is the face smiling
    smiles: null,
  };
            ...
            <View
              style={{
                ...
                <Text
                  ...
                  {this.state.faceDetected ? `Face Detected: ${this.state.smiles}` : 'No Face Detected'}
                </Text>
            </View>
          </Camera>
        </View>
  ...
  handleFacesDetected = ({ faces }) => {
    if (faces.length === 1){
      this.setState({
        ...
        smiles: this.isSmiling(faces[0].smilingProbability)
      });
      // console.log(faces[0].isSmiling)
...
//https://medium.com/@mheavers/build-a-face-detecting-react-native-selfie-cam-from-scratch-in-minutes-with-exponent-95ae7414febb
